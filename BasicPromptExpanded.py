...
def classify_sentence(prompt):
    ...
    output = model.generate(**inputs, max_length=inputs['input_ids'].shape[1] + 2, num_return_sequences=1,
...
with open("Results/resultsBasicEGPT.txt", "w", encoding="utf-8") as file:
